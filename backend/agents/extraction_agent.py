...
def create_extraction_agent(provider="openai", model="gpt-4o"):
    ...
    system_prompt = """You are the Document Extraction Subagent. Your expertise is finding, reading, and extracting information from complex financial documents on the internet.
